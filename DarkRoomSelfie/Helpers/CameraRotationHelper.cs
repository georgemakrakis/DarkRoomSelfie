...
//This whole class was taken as it is from https://docs.microsoft.com/en-us/windows/uwp/audio-video-camera/handle-device-orientation-with-mediacapture#camerarotationhelper-full-code-listing
using System;
...
namespace DarkRoomSelfie.Helpers
{
    class CameraRotationHelper
    {
        ...
        private SimpleOrientation GetCameraOrientationRelativeToNativeOrientation()
        {
            ...
            var enclosureAngle = ConvertClockwiseDegreesToSimpleOrientation((int)_cameraEnclosureLocation.Panel);
